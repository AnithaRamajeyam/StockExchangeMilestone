...
<body>
    ...
    <article>
        <form:form action="insertipo" method="post" modelAttribute="ipodetail">
            <p id="body-text">Add IPO Plan</p>
            <table>
                <tr>
                    <td><label>Company code</label></td>
                    <td><form:input path="companycode"  required="required" /></td>
                </tr>
                <tr>
                    <td><label>Stock exchange Name</label></td>
                    <td><form:input path="stockexchange_id" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><form:input path="totalshares" /></td>
                </tr>
                <tr>
                    <td><label>Open date time</label></td>
                    <td><form:input path="opendate" type="date"/></td>
                </tr>
                <tr>
